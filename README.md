...
**Team Members:** Yeong Chee Yaw & Neo Yong Xin  
...
- **Dataset:** Hillel Yaffe Glaucoma Dataset (HYGD) - A "Gold-Standard" annotated dataset via PhysioNet.
...
- `glaucoma_classifier_resnet34.pkl`: Model export (Note: Hosted on Google Drive).
